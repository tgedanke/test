...
'cname'=>iconv("windows-1251", "UTF-8", $row["cname"]), 'dest'=>iconv("windows-1251", "UTF-8", $row["dest"]),'destcode'=>$row["destcode"], 'dname'=>iconv("windows-1251", "UTF-8", $row["dname"]),
 ...
 'contphone'=>$row["contphone"], 'contmail'=>$row["contmail"], 'dcontphone'=>$row["dcontphone"],'dcontmail'=>$row["dcontmail"], 'address'=>iconv("windows-1251", "UTF-8", $row["address"]), 'dadr'=>iconv("windows-1251", "UTF-8", $row["dadr"]),
