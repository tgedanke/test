...
//echo "2";
print_r(json_encode(array('success'=>true, 'msg'=> "Заказ сохранен")));
} else {
     print_r(json_encode(array('success'=>false, 'msg'=> "Ошибка БД!")));
}
}catch (Exception $e) {
    print_r(json_encode(array('success'=>false, 'msg'=> "Ошибка Сервера")));
    }
